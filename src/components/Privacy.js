  ...
  return (
    ...
    >
      ...
      <Typography level="body">
        ...
        We do not warrant or represent that the service, information, operation and any data contained herein is accurate, current, complete or suitable for any particular purpose.
      ...
      <Typography level="body">
        Because of it's status as an experimental service which makes use of other vendors' services, you must not process production data using the service.
        ...
        commercially valuable, secret, or personal information to be processed via the service.
        It is a condition of using the service that you indemnify us against claims by any third party,
        which arise in whole or part from your processing any proprietary or personal data using of this service in breach of this condition.
      </Typography>
      <Typography level="body">
        ...
        <List>
          <ListItemText>Subject the service to unreasonable amounts of traffic which are inconsistent with simple experimentation bt one person - for the avoidance of doubt we consider reasonable usage to be no more than 2 concurrent calls, and no more than 120 minutes of total call duration per day over a period of up to a week.</ListItemText>
          ...
          <ListItemText>Use the service to place outbound calls, or connect the service via an outbound call to a human through external means.</ListItemText>
          <ListItemText>Undertake nuisance, non-serious, or prank calls or other uses of the technology which are not good faith technical prototyping and exploration.
            If in any doubt about the acceptability of a testing use case, please consult us before proceeeding.</ListItemText>
        </List>
        ...
        <List>
          <ListItemText>Disclose your uploaded identifiable data and transcripts verbatim either publicly or to any other third party without your permission.
            We may however process and disclose unattributed snippets and anonymised general patterns in data and their effects on the service which you originate to improve our and our users understanding.</ListItemText>
          <ListItemText>Use your data as part of a corpus to train any model or engine.</ListItemText>
        </List>
      ...
      <Typography level="body">
        Our lawful ground for this processing is our legitimate interests which in this case are to reply to communications sent to us,
        to keep business records and administer our communication with you about our products and services, managing our commercial relationship,
        and technically administering our systems.
      </Typography>
      ...
      <Typography level="body">
        ...
        You can see more about these rights at: <Link href="https://ico.org.uk/for-organisations/guide-to-the-general-data-protection-regulation-gdpr/individual-rights/">https://ico.org.uk/for-organisations/guide-to-the-general-data-protection-regulation-gdpr/individual-rights/</Link>.
      </Typography>
      <Typography level="body">
        If you wish to exercise any of the rights set out above, please email us at <Link href="mailto:hello@aplisay.uk">hello@aplisay.uk.</Link><br />
      ...
      <Typography level="body">
        ...
        In this case, we will notify you. If you are not happy with any aspect of how we collect and use your data, you have the right to complain to the Information Commissioner’s Office (ICO), the UK supervisory authority for data protection issues (<Link href="https://www.ico.org.uk">www.ico.org.uk</Link>).
